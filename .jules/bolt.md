...
**Action:** Look for modules or singletons that initialize state asynchronously and make sure they memoize the promise, not just the result. Always add `.catch` handlers to clear the cached promise if they fail.
