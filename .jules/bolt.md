...
## 2024-11-21 - Memory and socket leak with http.get errors
...
**Action:** Always call `req.destroy()` in the `error` event handler when using one-off requests with `agent: false`.
